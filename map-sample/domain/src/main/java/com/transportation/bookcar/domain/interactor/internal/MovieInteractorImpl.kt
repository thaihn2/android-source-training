...
import com.transportation.bookcar.domain.transform.toMovie
...
internal class MovieInteractorImpl @Inject constructor(
        ...
        private val localRepo: LocalRepo) : MovieInteractor {

    override fun getPopularMovies(page: Int): Single<PageList<Movie>> {
